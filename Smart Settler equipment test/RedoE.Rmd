...
fileName <- paste(path_out, "RedoB.csv", sep = "")
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Udstyrstest/DATALOGaaø28.03redo.xlsx", sheet = "40e")
...
Parameters[nrow(Parameters)+1,] <-c(Date, Equipment, SV_30, SS, n, DSVI, velocity)

parameterName <- paste(path_out, "Precisiontest_redo.csv", sep = "")
```
