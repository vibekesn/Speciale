...
fileName <- paste(path_out, "Skagen50.csv", sep = "")
testName <- "Skagen"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGskagen.xlsx", sheet = "50")
```
...
#hin_settling <- hin_settling[hin_settling$Height >70, ]
...
#hin_settling <- hin_settling[hin_settling$Timestamp <225, ]
