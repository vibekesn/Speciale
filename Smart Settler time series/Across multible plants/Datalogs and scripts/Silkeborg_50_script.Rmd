...
fileName <- paste(path_out, "Silkeborg50.csv", sep = "")
testName <- "Silkeborg"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGsilkeborg.xlsx", sheet = "50")
```
...
hin_settling <- hin_settling[hin_settling$Height >220, ]
...
#hin_settling <- hin_settling[hin_settling$Timestamp >150, ]
...
SV30_sub <- blanketheight[blanketheight$Timestamp >1500, ]
