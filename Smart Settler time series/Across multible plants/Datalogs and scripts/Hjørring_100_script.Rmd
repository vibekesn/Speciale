...
fileName <- paste(path_out, "Hjørring100.csv", sep = "")
testName <- "Hjørring"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGHjørring.xlsx", sheet = "100")
```
...
#hin_settling <- hin_settling[hin_settling$Timestamp <1000, ]
...
SV30_sub <- SV30_sub[SV30_sub$Volume >125, ]
