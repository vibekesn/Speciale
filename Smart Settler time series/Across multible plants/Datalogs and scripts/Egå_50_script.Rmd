...
fileName <- paste(path_out, "Egå50.csv", sep = "")
testName <- "Egå"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGegå.xlsx", sheet = "50")
```
...
#hin_settling <- hin_settling[hin_settling$Timestamp <220, ]
