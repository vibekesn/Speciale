...
fileName <- paste(path_out, "Viborg40.csv", sep = "")
testName <- "40"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/DATALOGviborg31.01.xlsx", sheet = "40")
```
...
hin_settling <- hin_settling[hin_settling$Height >33, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >33, ]
...
```{r}
Parameters<- read.csv( "D://Speciale/Data/Broad_inspection/Viborg_parameters.csv")
...
parameterName <- paste(path_out, "Viborg_parameters.csv", sep = "")
