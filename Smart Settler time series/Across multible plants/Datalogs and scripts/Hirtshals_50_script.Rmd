...
fileName <- paste(path_out, "Hirtshals50.csv", sep = "")
testName <- "Hirtshals"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGHirtshals.xlsx", sheet = "50")
```
...
SV30_sub <- SV30_sub[SV30_sub$Volume >25, ]
