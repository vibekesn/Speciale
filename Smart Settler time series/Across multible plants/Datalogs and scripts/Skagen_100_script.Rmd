...
fileName <- paste(path_out, "Skagen100.csv", sep = "")
testName <- "Skagen"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGskagen.xlsx", sheet = "100")
```
...
hin_settling <- hin_settling[hin_settling$Height >225, ]
