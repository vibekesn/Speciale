...
fileName <- paste(path_out, "Egå75.csv", sep = "")
testName <- "Egå"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGegå.xlsx", sheet = "75")
```
...
#hin_settling <- hin_settling[hin_settling$Timestamp <230, ]
