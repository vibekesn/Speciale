...
fileName <- paste(path_out, "Viby100.csv", sep = "")
testName <- "Viby"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGviby.xlsx", sheet = "100")
```
...
hin_settling <- hin_settling[hin_settling$Height >170, ]
