...
fileName <- paste(path_out, "Silkeborg75.csv", sep = "")
testName <- "Silkeborg"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGsilkeborg.xlsx", sheet = "75")
```
...
hin_settling <- hin_settling[hin_settling$Height >250, ]
...
#hin_settling <- hin_settling[hin_settling$Height >215, ]
...
#hin_settling <- hin_settling[hin_settling$Timestamp <200, ]
