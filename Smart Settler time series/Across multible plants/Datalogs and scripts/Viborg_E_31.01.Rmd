...
fileName <- paste(path_out, "Viborg4A.csv", sep = "")
testName <- "4A"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/DATALOGviborg31.01.xlsx", sheet = "4A")
```
...
diff_by5 <- diff(as.matrix(hin_settling$Height), lag = 40)
...
max_slope_span <- max_diff_index +40L
