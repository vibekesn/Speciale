...
fileName <- paste(path_out, "Skagen75.csv", sep = "")
testName <- "Skagen"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGskagen.xlsx", sheet = "75")
```
...
#hin_settling <- hin_settling[hin_settling$Height >125, ]
...
#hin_settling <- hin_settling[hin_settling$Timestamp <1250, ]
