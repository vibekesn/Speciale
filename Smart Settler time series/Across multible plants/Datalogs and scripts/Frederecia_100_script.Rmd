...
fileName <- paste(path_out, "Frederecia100.csv", sep = "")
testName <- "Frederecia"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGfrederecia.xlsx", sheet = "100")
```
...
hin_settling <- hin_settling[hin_settling$Height >200, ]
...
#hin_settling <- hin_settling[hin_settling$Height >175, ]
...
#hin_settling <- hin_settling[hin_settling$Timestamp <1750, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >175, ]
