...
fileName <- paste(path_out, "Viborg10.csv", sep = "")
testName <- "10"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/DATALOGviborg31.01.xlsx", sheet = "10")
```
...
hin_settling <- hin_settling[hin_settling$Height >20, ]
