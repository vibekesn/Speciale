...
fileName <- paste(path_out, "Frederecia75.csv", sep = "")
testName <- "Frederecia"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGfrederecia.xlsx", sheet = "75")
```
...
#hin_settling <- hin_settling[hin_settling$Timestamp <350, ]
