...
fileName <- paste(path_out, "Hirtshals100.csv", sep = "")
testName <- "Hirtshals"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGHirtshals.xlsx", sheet = "100")
```
...
#hin_settling <- hin_settling[hin_settling$Timestamp <500, ]
