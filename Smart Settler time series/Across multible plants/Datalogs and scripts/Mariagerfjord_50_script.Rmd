...
fileName <- paste(path_out, "mariagerfjord50.csv", sep = "")
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Broad_inspection/DATALOGmariagerfjord.xlsx", sheet = "50")
```
...
#hin_settling <- hin_settling[hin_settling$Height >25, ]
