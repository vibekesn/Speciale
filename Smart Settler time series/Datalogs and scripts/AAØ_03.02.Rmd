...
fileName <- paste(path_out, "AAØ_03.02.csv", sep = "")
Date <- "03.02.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaø22.02.xlsx", sheet = "03.02")
```
...
hin_settling <- hin_settling[hin_settling$Height >98, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >98, ]
