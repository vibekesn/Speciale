...
fileName <- paste(path_out, "AAØ_23.01.csv", sep = "")
Date <- "23.01.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaø23.01.xlsx", sheet = "23.01_500")
```
...
SV30_sub <- SV30_sub[SV30_sub$Height >100, ]
