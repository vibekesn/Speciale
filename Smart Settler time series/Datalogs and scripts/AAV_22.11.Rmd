...
fileName <- paste(path_out, "AAV_22.11.csv", sep = "")
Date <- "22.11.2022"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaV17.11-12.12.xlsx", sheet = "22.11")
```
...
SV30_sub <- SV30_sub[SV30_sub$Volume >68, ]
