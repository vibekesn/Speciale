...
fileName <- paste(path_out, "AAV_02.03.csv", sep = "")
Date <- "02.03.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaav23.02-27.03.xlsx", sheet = "02.03sv")
```
...
hin_settling <- hin_settling[hin_settling$Height >124, ]
