...
fileName <- paste(path_out, "DAM_22.12.csv", sep = "")
Date <- "22.12.2022"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos22.12.xlsx", sheet= "22.12")
...
blanketheight <- blanketheight[blanketheight$Volume >112, ]
