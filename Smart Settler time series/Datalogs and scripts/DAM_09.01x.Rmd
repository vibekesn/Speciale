...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos09.01.xlsx", sheet= "09.01x")
...
hin_settling <- hin_settling[hin_settling$Height >241, ]
...
SV30_sub <- SV30_sub[SV30_sub$Timestamp <2500, ]
#removing scewing datapoints
SV30_sub <- SV30_sub[SV30_sub$Height >241, ]
