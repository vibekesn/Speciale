...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/AAØfortyndingsserie/DATALOGaaø20.02.xlsx", sheet = "100")
```
...
hin_settling <- hin_settling[hin_settling$Height >267, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >265, ]
