...
fileName <- paste(path_out, "AAV_12.12.csv", sep = "")
Date <- "12.12.2022"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaV17.11-12.12.xlsx", sheet = "12.12")
```
...
SV30_sub <- SV30_sub[SV30_sub$Volume >112, ]
