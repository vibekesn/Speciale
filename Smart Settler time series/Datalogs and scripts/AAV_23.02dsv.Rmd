...
fileName <- paste(path_out, "AAV_23.02.csv", sep = "")
Date <- "23.02.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaav23.02-27.03.xlsx", sheet = "23.02dsv")
```
...
SV30_sub <- SV30_sub[SV30_sub$Volume >250, ]
