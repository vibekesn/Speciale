...
fileName <- paste(path_out, "AAØ_06.02_500.csv", sep = "")
Date <- "06.02.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaø22.02.xlsx", sheet = "06.02-500")
```
...
hin_settling <- hin_settling[hin_settling$Height >137, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >137, ]
