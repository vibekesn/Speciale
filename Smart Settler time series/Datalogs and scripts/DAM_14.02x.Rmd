...
fileName <- paste(path_out, "DAM_14.02.csv", sep = "")
Date <- "14.02.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos14.02.xlsx", sheet= "14.02x")
...
SV30_sub <- SV30_sub[SV30_sub$Height >267, ]
