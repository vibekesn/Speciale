...
fileName <- paste(path_out, "DAM_27.03.csv", sep = "")
Date <- "27.03.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos15.03-27.03.xlsx", sheet= "27.03sv")
...
hin_settling <- hin_settling[hin_settling$Height >270, ]


#find difference between every 5th row (70 s)
diff_by5 <- diff(as.matrix(hin_settling$Height), lag = 2)
...
max_slope_span <- max_diff_index +2L
...
SV30_sub <- SV30_sub[SV30_sub$Height >270, ]
