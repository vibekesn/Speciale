...
fileName <- paste(path_out, "AAV_22.03.csv", sep = "")
Date <- "22.03.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaav23.02-27.03.xlsx", sheet = "22.03sv")
```
...
hin_settling <- hin_settling[hin_settling$Height >176, ]
