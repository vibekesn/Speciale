...
fileName <- paste(path_out, "AAØ_22.02.csv", sep = "")
Date <- "22.02.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/AAØfortyndingsserie/DATALOGaaø20.02.xlsx", sheet = "50")
```
...
hin_settling <- hin_settling[hin_settling$Height >111, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >111, ]
