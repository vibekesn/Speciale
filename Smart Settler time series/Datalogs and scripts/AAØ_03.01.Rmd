...
fileName <- paste(path_out, "AAØ_03.01.csv", sep = "")
Date <- "03.01.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaø14.12-16.01.xlsx", sheet = "03.01")
```
...
hin_settling <- hin_settling[hin_settling$Height >46, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >46, ]
