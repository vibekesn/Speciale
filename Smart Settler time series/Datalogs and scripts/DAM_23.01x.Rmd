...
fileName <- paste(path_out, "DAM_23.01x.csv", sep = "")
Date <- "23.01.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos18.01-23.01.xlsx", sheet= "23.01x")
...
hin_settling <- hin_settling[hin_settling$Height >202, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >202, ]
