...
fileName <- paste(path_out, "AAV_11.01.csv", sep = "")
Date <- "11.01.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaV11.01-23.01.xlsx", sheet = "11.01")
```
...
SV30_sub <- SV30_sub[SV30_sub$Volume >59, ]
