...
fileName <- paste(path_out, "DAM_18.01.csv", sep = "")
Date <- "18.01.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos18.01-23.01.xlsx", sheet= "18.01")
...
SV30_sub <- SV30_sub[SV30_sub$Height >45, ]
