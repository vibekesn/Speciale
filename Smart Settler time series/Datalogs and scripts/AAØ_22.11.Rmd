...
fileName <- paste(path_out, "AAØ_22.11.csv", sep = "")
Date <- "22.11.2022"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaø15.11-29.11.xlsx", sheet = "22.11")
```
...
SV30_sub <- SV30_sub[SV30_sub$Height >50, ]
