...
fileName <- paste(path_out, "DAM_31.01x.csv", sep = "")
Date <- "31.01.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos31.01-07.02.xlsx", sheet= "31.01x")
...
hin_settling <- hin_settling[hin_settling$Height >254, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >254, ]
