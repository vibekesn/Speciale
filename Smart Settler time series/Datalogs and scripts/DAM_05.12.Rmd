...
fileName <- paste(path_out, "DAM_05.12.csv", sep = "")
Date <- "05.12.2022"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos05.12.xlsx", sheet = "05.12")
...
#hin_settling <- hin_settling[hin_settling$Height >210, ]
...
#SV30_sub <- SV30_sub[SV30_sub$Height >210, ]
