...
fileName <- paste(path_out, "AAØ_27.03.csv", sep = "")
Date <- "27.03.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaø28.02-27.03.xlsx", sheet = "27.03")
```
...
hin_settling <- hin_settling[hin_settling$Height >72, ]


#find difference between every 5th row (70 s)
diff_by5 <- diff(as.matrix(hin_settling$Height), lag = 20)
...
max_slope_span <- max_diff_index +20L
...
SV30_sub <- SV30_sub[SV30_sub$Height >72, ]
