...
fileName <- paste(path_out, "AAØ_20.03.csv", sep = "")
Date <- "20.03.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaø28.02-27.03.xlsx", sheet = "20.03")
```
...
diff_by5 <- diff(as.matrix(hin_settling$Height), lag = 18)
...
max_slope_span <- max_diff_index +18L
