...
fileName <- paste(path_out, "DAM_12.12x.csv", sep = "")
Date <- "12.12.2022"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos12.12.xlsx", sheet= "12.12x")
...
SV30_sub <- blanketheight[blanketheight$Timestamp >0, ]
SV30_sub <- SV30_sub[SV30_sub$Timestamp <2000, ]
#removing scewing datapoints
SV30_sub <- SV30_sub[SV30_sub$Height >250, ]
