...
fileName <- paste(path_out, "AAØ_14.03.csv", sep = "")
Date <- "14.03.2023"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaaø28.02-27.03.xlsx", sheet = "14.03")
```
...
hin_settling <- hin_settling[hin_settling$Height >71, ]
...
SV30_sub <- SV30_sub[SV30_sub$Height >71, ]
