...
fileName <- paste(path_out, "DAM_24.11.csv", sep = "")
Date <- "24.11.2022"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/Biofos24.11.xlsx", sheet = "24.11")
```
...
SV30_sub <- blanketheight[blanketheight$Timestamp >300, ]
SV30_sub <- SV30_sub[SV30_sub$Timestamp <3000, ]
#removing scewing datapoints
SV30_sub <- SV30_sub[SV30_sub$Height >15, ]
