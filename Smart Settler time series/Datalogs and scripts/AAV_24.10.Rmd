...
fileName <- paste(path_out, "AAV_24.10.csv", sep = "")
Date <- "24.10.2022"
```
...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/DATALOGaalborgV17.10-09.11.xlsx", sheet = "24.10")
```
...
SV30_sub <- blanketheight[blanketheight$Timestamp >520, ]
SV30_sub <- SV30_sub[SV30_sub$Timestamp <2000, ]
#removing scewing datapoints
SV30_sub <- SV30_sub[SV30_sub$Volume >110, ]
