...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/AAØfortyndingsserie/AAØfortyndingsserie01.12.xlsx", sheet = "40")
...
fileName <- paste(path_out, "AAØfortyndingsserie40.csv", sep = "")
Date <- "01.12.2022"
