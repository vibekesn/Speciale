...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/AAØfortyndingsserie/DATALOGaaø28.03.xlsx", sheet = "20")
...
diff_by5 <- diff(as.matrix(hin_settling$Height), lag = 9)
...
max_slope_span <- max_diff_index +9L
