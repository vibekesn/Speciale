...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/AAØfortyndingsserie/AAØfortyndingsserie01.12.xlsx", sheet = "30")
...
fileName <- paste(path_out, "AAØfortyndingsserie30.csv", sep = "")
Date <- "01.12.2022"
