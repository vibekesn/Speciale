...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/AAØfortyndingsserie/DATALOGaaø28.03.xlsx", sheet = "60")
...
hin_settling <- hin_settling[hin_settling$Height >160, ]
#hin_settling <- hin_settling[hin_settling$Timestamp >100, ]

#find difference between every 5th row (70 s)
diff_by5 <- diff(as.matrix(hin_settling$Height), lag = 11)
...
max_slope_span <- max_diff_index +11L
