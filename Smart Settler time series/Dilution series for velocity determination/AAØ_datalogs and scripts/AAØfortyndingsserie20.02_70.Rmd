...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/AAØfortyndingsserie/DATALOGaaø20.02.xlsx", sheet = "70")
...
#hin_settling <- hin_settling[hin_settling$Timestamp >100, ]
