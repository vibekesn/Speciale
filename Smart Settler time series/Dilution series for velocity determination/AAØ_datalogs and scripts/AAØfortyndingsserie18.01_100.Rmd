...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/AAØfortyndingsserie/DATALOGaaø_hastighed18.01.xlsx", sheet = "100")
...
diff_by5 <- diff(as.matrix(hin_settling$Height), lag = 30)
...
max_slope_span <- max_diff_index +30L
...
fileName <- paste(path_out, "AAØfortyndingsserie100.csv", sep = "")
Date <- "18.01.2023"
