...
```{r}
d<- openxlsx::read.xlsx( "D://Speciale/Data/Time_series/AAØfortyndingsserie/DATALOGaaø_hastighed18.01.xlsx", sheet = "60")
...
fileName <- paste(path_out, "AAØfortyndingsserie60.csv", sep = "")
Date <- "18.01.2023"
